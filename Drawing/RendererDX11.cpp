...
namespace OSHGui
{
	namespace Drawing
	{
		...
		//---------------------------------------------------------------------------
		Drawing::Size RendererDX11::MeasureText(Drawing::IFont *font, const String &text)
		{
			if (font == NULL)
			{
				return Size();
		...
		//---------------------------------------------------------------------------
		void RendererDX11::RenderText(Drawing::IFont *font, const Drawing::Point &point, const String &text)
		{
			RenderText(point.X, point.Y, 1000, 100, text);
		}
		//---------------------------------------------------------------------------
		void RendererDX11::RenderText(Drawing::IFont *font, int x, int y, const String &text)
		{
			RenderText(x, y, 1000, 100, text);
		}
		//---------------------------------------------------------------------------
		void RendererDX11::RenderText(Drawing::IFont *font, const Drawing::Rectangle &rectangle, const String &text)
		{
			RenderText(rectangle.GetLeft(), rectangle.GetTop(), rectangle.GetWidth(), rectangle.GetHeight(), text);
		}
		//---------------------------------------------------------------------------
		void RendererDX11::RenderText(Drawing::IFont *font, int x, int y, int w, int h, const String &text)
		{
			if (font == NULL)
			{
				return;
